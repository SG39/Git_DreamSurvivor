...
public class StatusControllerProjectorSpeed: MonoBehaviour
{
    ...
    private int iLevel = PlayerStatusManager.Instance.projectorSpeedLevel;
    private int iAmount = PlayerStatusManager.Instance.projectorSpeedAmount;
    private float fFigure = PlayerStatusManager.Instance.projectorSpeedFigure;
    private List<float> goldList = PlayerStatusManager.Instance.projectorSpeedGoldList;
    private float fMaxGoldAmount = PlayerStatusManager.Instance.projectorSpeedGoldMaxAmount;
...
#region 이벤트 트리거 등록 
   ...
   {
        // 이벤트 트리거 컴포넌트 가져오기
        EventTrigger projectorSpeedTrigger = statusBtn.gameObject.AddComponent<EventTrigger>();
        ...
        projectorSpeedTrigger.triggers.Add(buttonDownEntry);
