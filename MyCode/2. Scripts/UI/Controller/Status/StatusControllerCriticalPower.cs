...
public class StatusControllerCriticalPower : MonoBehaviour
{
    ...
    private int iLevel = PlayerStatusManager.Instance.criticalPowerLevel;
    private int iAmount = PlayerStatusManager.Instance.criticalPowerAmount;
    private float fFigure = PlayerStatusManager.Instance.criticalPowerFigure;
    private List<float> goldList = PlayerStatusManager.Instance.criticalPowerGoldList;
    private float fMaxGoldAmount = PlayerStatusManager.Instance.criticalPowerGoldMaxAmount;
...
#region 이벤트 트리거 등록 
   ...
   {
        // 이벤트 트리거 컴포넌트 가져오기
        EventTrigger criticalPowerTrigger = statusBtn.gameObject.AddComponent<EventTrigger>();
        ...
        criticalPowerTrigger.triggers.Add(buttonDownEntry);
