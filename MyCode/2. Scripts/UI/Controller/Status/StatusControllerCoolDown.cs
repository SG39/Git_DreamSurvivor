...
public class StatusControllerCoolDown : MonoBehaviour
{
    ...
    private int iLevel = PlayerStatusManager.Instance.coolDownLevel;
    private int iAmount = PlayerStatusManager.Instance.coolDownAmount;
    private float fFigure = PlayerStatusManager.Instance.coolDownFigure;
    private List<float> goldList = PlayerStatusManager.Instance.coolDownGoldList;
    private float fMaxGoldAmount = PlayerStatusManager.Instance.coolDownGoldMaxAmount;
...
#region 이벤트 트리거 등록 
   ...
   {
        // 이벤트 트리거 컴포넌트 가져오기
        EventTrigger coolDownTrigger = statusBtn.gameObject.AddComponent<EventTrigger>();
        ...
        coolDownTrigger.triggers.Add(buttonDownEntry);
