...
public class StatusControllerProtection : MonoBehaviour
{
    ...
    private int iLevel = PlayerStatusManager.Instance.protectionLevel;
    private int iAmount = PlayerStatusManager.Instance.protectionAmount;
    private float fFigure = PlayerStatusManager.Instance.protectionFigure;
    private List<float> goldList = PlayerStatusManager.Instance.protectionGoldList;
    private float fMaxGoldAmount = PlayerStatusManager.Instance.protectionGoldMaxAmount;
...
#region 이벤트 트리거 등록 
   ...
   {
        // 이벤트 트리거 컴포넌트 가져오기
        EventTrigger protectionTrigger = statusBtn.gameObject.AddComponent<EventTrigger>();
        ...
        protectionTrigger.triggers.Add(buttonDownEntry);
