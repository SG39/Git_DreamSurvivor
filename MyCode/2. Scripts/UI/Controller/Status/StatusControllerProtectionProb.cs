...
public class StatusControllerProtectionProb : MonoBehaviour
{
    ...
    private int iLevel = PlayerStatusManager.Instance.protectionProbLevel;
    private int iAmount = PlayerStatusManager.Instance.protectionProbAmount;
    private float fFigure = PlayerStatusManager.Instance.protectionProbFigure;
    private List<float> goldList = PlayerStatusManager.Instance.protectionProbGoldList;
    private float fMaxGoldAmount = PlayerStatusManager.Instance.protectionProbGoldMaxAmount;
...
#region 이벤트 트리거 등록 
   ...
   {
        // 이벤트 트리거 컴포넌트 가져오기
        EventTrigger protectionProbTrigger = statusBtn.gameObject.AddComponent<EventTrigger>();
        ...
        protectionProbTrigger.triggers.Add(buttonDownEntry);
