...
public class StatusControllerGoldGain : MonoBehaviour
{
    ...
    private int iLevel = PlayerStatusManager.Instance.goldGainLevel;
    private int iAmount = PlayerStatusManager.Instance.goldGainAmount;
    private float fFigure = PlayerStatusManager.Instance.goldGainFigure;
    private List<float> goldList = PlayerStatusManager.Instance.goldGainGoldList;
    private float fMaxGoldAmount = PlayerStatusManager.Instance.goldGainGoldMaxAmount;
...
#region 이벤트 트리거 등록 
   ...
   {
        // 이벤트 트리거 컴포넌트 가져오기
        EventTrigger goldGainTrigger = statusBtn.gameObject.AddComponent<EventTrigger>();
        ...
        goldGainTrigger.triggers.Add(buttonDownEntry);
