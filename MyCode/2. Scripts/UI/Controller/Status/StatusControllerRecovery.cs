...
public class StatusControllerRecovery : MonoBehaviour
{
    ...
    private int iLevel = PlayerStatusManager.Instance.recoveryLevel;
    private int iAmount = PlayerStatusManager.Instance.recoveryAmount;
    private float fFigure = PlayerStatusManager.Instance.recoveryFigure;
    private List<float> goldList = PlayerStatusManager.Instance.recoveryGoldList;
    private float fMaxGoldAmount = PlayerStatusManager.Instance.recoveryGoldMaxAmount;

    [SerializeField]private float fFigureOrigen = 0;
    [SerializeField]private float fFigureIncrease = 10;
    [SerializeField]private float fGoldOrigen = 1000;
    [SerializeField]private float fGoldIncrease = 500;
...
#region 이벤트 트리거 등록 
   ...
   {
        // 이벤트 트리거 컴포넌트 가져오기
        EventTrigger recoveryTrigger = statusBtn.gameObject.AddComponent<EventTrigger>();
        ...
        recoveryTrigger.triggers.Add(buttonDownEntry);
...
#region 각 스테이터스 정보갱신
    ...
    {
        UIFunctionClass.Instance.LevelToStatus(iLevel, out fFigure, this.fFigureOrigen, this.fFigureIncrease, out fMaxGoldAmount, this.fGoldIncrease, this.fGoldIncrease);
