...
public class StatusControllerExpIncreaseGain : MonoBehaviour
{
    ...
    private int iLevel = PlayerStatusManager.Instance.expIncreaseGainLevel;
    private int iAmount = PlayerStatusManager.Instance.expIncreaseGainAmount;
    private float fFigure = PlayerStatusManager.Instance.expIncreaseGainFigure;
    private List<float> goldList = PlayerStatusManager.Instance.expIncreaseGainGoldList;
    private float fMaxGoldAmount = PlayerStatusManager.Instance.expIncreaseGainGoldMaxAmount;
...
#region 이벤트 트리거 등록 
   ...
   {
        // 이벤트 트리거 컴포넌트 가져오기
        EventTrigger expIncreaseGainTrigger = statusBtn.gameObject.AddComponent<EventTrigger>();
        ...
        expIncreaseGainTrigger.triggers.Add(buttonDownEntry);
