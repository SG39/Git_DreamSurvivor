...
public class StatusControllerAttackRange : MonoBehaviour
{
    ...
    private int iLevel = PlayerStatusManager.Instance.attackRangeLevel;
    private int iAmount = PlayerStatusManager.Instance.attackRangeAmount;
    private float fFigure = PlayerStatusManager.Instance.attackRangeFigure;
    private List<float> goldList = PlayerStatusManager.Instance.attackRangeGoldList;
    private float fMaxGoldAmount = PlayerStatusManager.Instance.attackRangeGoldMaxAmount;
...
#region 이벤트 트리거 등록 
   ...
   {
        // 이벤트 트리거 컴포넌트 가져오기
        EventTrigger attackRangeTrigger = statusBtn.gameObject.AddComponent<EventTrigger>();
        ...
        attackRangeTrigger.triggers.Add(buttonDownEntry);
