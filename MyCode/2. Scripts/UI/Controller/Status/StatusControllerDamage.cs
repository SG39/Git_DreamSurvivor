...
public class StatusControllerDamage : MonoBehaviour
{
    ...
    private int iLevel = PlayerStatusManager.Instance.damageLevel;
    private int iAmount = PlayerStatusManager.Instance.damageAmount;
    private float fFigure = PlayerStatusManager.Instance.damageFigure;
    private List<float> goldList = PlayerStatusManager.Instance.damageGoldList;
    private float fMaxGoldAmount = PlayerStatusManager.Instance.damageGoldMaxAmount;
...
#region 이벤트 트리거 등록 
   ...
   {
        // 이벤트 트리거 컴포넌트 가져오기
        EventTrigger damageTrigger = statusBtn.gameObject.AddComponent<EventTrigger>();
        ...
        damageTrigger.triggers.Add(buttonDownEntry);
