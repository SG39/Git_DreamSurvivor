...
public class StatusControllerCriticalProb : MonoBehaviour
{
    ...
    private int iLevel = PlayerStatusManager.Instance.criticalProbLevel;
    private int iAmount = PlayerStatusManager.Instance.criticalProbAmount;
    private float fFigure = PlayerStatusManager.Instance.criticalProbFigure;
    private List<float> goldList = PlayerStatusManager.Instance.criticalProbGoldList;
    private float fMaxGoldAmount = PlayerStatusManager.Instance.criticalProbGoldMaxAmount;
...
#region 이벤트 트리거 등록 
   ...
   {
        // 이벤트 트리거 컴포넌트 가져오기
        EventTrigger criticalProbTrigger = statusBtn.gameObject.AddComponent<EventTrigger>();
        ...
        criticalProbTrigger.triggers.Add(buttonDownEntry);
