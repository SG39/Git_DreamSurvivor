...
public class StatusControllerAttackOfNumber : MonoBehaviour
{
    ...
    private int iLevel = PlayerStatusManager.Instance.attackOfNumberLevel;
    private int iAmount = PlayerStatusManager.Instance.attackOfNumberAmount;
    private float fFigure = PlayerStatusManager.Instance.attackOfNumberFigure;
    private List<float> goldList = PlayerStatusManager.Instance.attackOfNumberGoldList;
    private float fMaxGoldAmount = PlayerStatusManager.Instance.attackOfNumberGoldMaxAmount;
...
#region 이벤트 트리거 등록 
   ...
   {
        // 이벤트 트리거 컴포넌트 가져오기
        EventTrigger attackOfNumberTrigger = statusBtn.gameObject.AddComponent<EventTrigger>();
        ...
        attackOfNumberTrigger.triggers.Add(buttonDownEntry);
